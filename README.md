...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-tools@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { binary, binaryFactory, nullary, ternary, ternaryFactory, unary, unaryFactory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-tools@v0.2.2-esm/index.mjs';
```
